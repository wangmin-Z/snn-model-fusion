...
| --- | --- | ---: | ---: | ---: |
| ANN ResNet-18 | `outputs/paper_full_120_20260704/ucm80_ann_resnet18_img224_e120_seed42` | 89 | 66.67% | 64.76% |
| SNN-MFT ResNet-18, `T=4` | `outputs/paper_full_120_20260704/ucm80_snn_mft_resnet18_T4_img224_e120_seed42` | 44 | 56.43% | 54.05% |
...
这不是论文完整实验矩阵。论文还包含 AID、RSSCN7、多个训练划分、多个时间窗 `T=2/4/6/8`、不同深度网络和多随机种子。当前仓库已经实现可运行的复现代码，并完成 UCM 80/20 子集的 120 轮 ANN 与 SNN-MFT 训练。
